...
{
    public class SiniestrosVehiculoConfiguration : IEntityTypeConfiguration<SiniestrosVehiculo>
    {
        public void Configure(EntityTypeBuilder<SiniestrosVehiculo> entity)
        {
